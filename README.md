...
| `2.20`       | master       | **`2.20.x`** | `amd64`, `arm64`                             |
| `2.19`       | master       | **`2.19.x`** | `amd64`, `arm64`                             |
| `2.18`       | master       | **`2.18.x`** | `amd64`, `arm64`                             |
| `2.17`       | master       | **`2.17.x`** | `amd64`, `arm64`                             |
| `2.16`       | master       | **`2.16.x`** | `amd64`, `arm64`                             |
...
| `2.20-tools`             | master       | **`2.20.x`** | `amd64`, `arm64`                             |
| `2.19-tools`             | master       | **`2.19.x`** | `amd64`, `arm64`                             |
| `2.18-tools`             | master       | **`2.18.x`** | `amd64`, `arm64`                             |
| `2.17-tools`             | master       | **`2.17.x`** | `amd64`, `arm64`                             |
| `2.16-tools`             | master       | **`2.16.x`** | `amd64`, `arm64`                             |
...
| `2.20-azure`             | master       | **`2.20.x`** | `amd64`, `arm64`                             |
| `2.19-azure`             | master       | **`2.19.x`** | `amd64`, `arm64`                             |
| `2.18-azure`             | master       | **`2.18.x`** | `amd64`, `arm64`                             |
| `2.17-azure`             | master       | **`2.17.x`** | `amd64`, `arm64`                             |
| `2.16-azure`             | master       | **`2.16.x`** | `amd64`, `arm64`                             |
...
| `2.20-aws`               | master       | **`2.20.x`** | `amd64`, `arm64`                             |
| `2.19-aws`               | master       | **`2.19.x`** | `amd64`, `arm64`                             |
| `2.18-aws`               | master       | **`2.18.x`** | `amd64`, `arm64`                             |
| `2.17-aws`               | master       | **`2.17.x`** | `amd64`, `arm64`                             |
| `2.16-aws`               | master       | **`2.16.x`** | `amd64`, `arm64`                             |
...
| `2.20-awsk8s`            | master       | **`2.20.x`** | `amd64`, `arm64`                             |
| `2.19-awsk8s`            | master       | **`2.19.x`** | `amd64`, `arm64`                             |
| `2.18-awsk8s`            | master       | **`2.18.x`** | `amd64`, `arm64`                             |
| `2.17-awsk8s`            | master       | **`2.17.x`** | `amd64`, `arm64`                             |
| `2.16-awsk8s`            | master       | **`2.16.x`** | `amd64`, `arm64`                             |
...
|--------------------------|--------------|--------------|----------|-----------------------------------|
| **`latest-awskops1.34`** | master       | latest       | `1.34.x` | `amd64`, `arm64`                  |
| `2.20-awskops1.34`       | master       | **`2.20.x`** | `1.34.x` | `amd64`, `arm64`                  |
| `2.19-awskops1.34`       | master       | **`2.19.x`** | `1.34.x` | `amd64`, `arm64`                  |
| `2.18-awskops1.34`       | master       | **`2.18.x`** | `1.34.x` | `amd64`, `arm64`                  |
| `2.17-awskops1.34`       | master       | **`2.17.x`** | `1.34.x` | `amd64`, `arm64`                  |
| `2.16-awskops1.34`       | master       | **`2.16.x`** | `1.34.x` | `amd64`, `arm64`                  |
...
| `2.19-awskops1.33`       | master       | **`2.19.x`** | `1.33.x` | `amd64`, `arm64`                  |
| `2.18-awskops1.33`       | master       | **`2.18.x`** | `1.33.x` | `amd64`, `arm64`                  |
| `2.17-awskops1.33`       | master       | **`2.17.x`** | `1.33.x` | `amd64`, `arm64`                  |
| `2.16-awskops1.33`       | master       | **`2.16.x`** | `1.33.x` | `amd64`, `arm64`                  |
...
| `2.19-awskops1.32`       | master       | **`2.19.x`** | `1.32.x` | `amd64`, `arm64`                  |
| `2.18-awskops1.32`       | master       | **`2.18.x`** | `1.32.x` | `amd64`, `arm64`                  |
| `2.17-awskops1.32`       | master       | **`2.17.x`** | `1.32.x` | `amd64`, `arm64`                  |
| `2.16-awskops1.32`       | master       | **`2.16.x`** | `1.32.x` | `amd64`, `arm64`                  |
...
| `2.19-awskops1.31`       | master       | **`2.19.x`** | `1.31.x` | `amd64`, `arm64`                  |
| `2.18-awskops1.31`       | master       | **`2.18.x`** | `1.31.x` | `amd64`, `arm64`                  |
| `2.17-awskops1.31`       | master       | **`2.17.x`** | `1.31.x` | `amd64`, `arm64`                  |
| `2.16-awskops1.31`       | master       | **`2.16.x`** | `1.31.x` | `amd64`, `arm64`                  |
...
| `2.19-awskops1.30`       | master       | **`2.19.x`** | `1.30.x` | `amd64`, `arm64`                  |
| `2.18-awskops1.30`       | master       | **`2.18.x`** | `1.30.x` | `amd64`, `arm64`                  |
| `2.17-awskops1.30`       | master       | **`2.17.x`** | `1.30.x` | `amd64`, `arm64`                  |
| `2.16-awskops1.30`       | master       | **`2.16.x`** | `1.30.x` | `amd64`, `arm64`                  |
...
|--------------------------|--------------|--------------|----------|-----------------------------------|
| **`latest-awshelm3.20`** | master       | latest       | `3.20.x` | `amd64`, `arm64`                  |
| `2.20-awshelm3.20`       | master       | **`2.20.x`** | `3.20.x` | `amd64`, `arm64`                  |
| `2.19-awshelm3.20`       | master       | **`2.19.x`** | `3.20.x` | `amd64`, `arm64`                  |
| `2.18-awshelm3.20`       | master       | **`2.18.x`** | `3.20.x` | `amd64`, `arm64`                  |
| `2.17-awshelm3.20`       | master       | **`2.17.x`** | `3.20.x` | `amd64`, `arm64`                  |
| `2.16-awshelm3.20`       | master       | **`2.16.x`** | `3.20.x` | `amd64`, `arm64`                  |
...
| `2.19-awshelm3.19`       | master       | **`2.19.x`** | `3.19.x` | `amd64`, `arm64`                  |
| `2.18-awshelm3.19`       | master       | **`2.18.x`** | `3.19.x` | `amd64`, `arm64`                  |
| `2.17-awshelm3.19`       | master       | **`2.17.x`** | `3.19.x` | `amd64`, `arm64`                  |
| `2.16-awshelm3.19`       | master       | **`2.16.x`** | `3.19.x` | `amd64`, `arm64`                  |
...
| `2.19-awshelm3.18`       | master       | **`2.19.x`** | `3.18.x` | `amd64`, `arm64`                  |
| `2.18-awshelm3.18`       | master       | **`2.18.x`** | `3.18.x` | `amd64`, `arm64`                  |
| `2.17-awshelm3.18`       | master       | **`2.17.x`** | `3.18.x` | `amd64`, `arm64`                  |
| `2.16-awshelm3.18`       | master       | **`2.16.x`** | `3.18.x` | `amd64`, `arm64`                  |
...
| `2.19-awshelm3.17`       | master       | **`2.19.x`** | `3.17.x` | `amd64`, `arm64`                  |
| `2.18-awshelm3.17`       | master       | **`2.18.x`** | `3.17.x` | `amd64`, `arm64`                  |
| `2.17-awshelm3.17`       | master       | **`2.17.x`** | `3.17.x` | `amd64`, `arm64`                  |
| `2.16-awshelm3.17`       | master       | **`2.16.x`** | `3.17.x` | `amd64`, `arm64`                  |
...
| `2.19-awshelm3.16`       | master       | **`2.19.x`** | `3.16.x` | `amd64`, `arm64`                  |
| `2.18-awshelm3.16`       | master       | **`2.18.x`** | `3.16.x` | `amd64`, `arm64`                  |
| `2.17-awshelm3.16`       | master       | **`2.17.x`** | `3.16.x` | `amd64`, `arm64`                  |
| `2.16-awshelm3.16`       | master       | **`2.16.x`** | `3.16.x` | `amd64`, `arm64`                  |
...
| `2.19-awshelm3.15`       | master       | **`2.19.x`** | `3.15.x` | `amd64`, `arm64`                  |
| `2.18-awshelm3.15`       | master       | **`2.18.x`** | `3.15.x` | `amd64`, `arm64`                  |
| `2.17-awshelm3.15`       | master       | **`2.17.x`** | `3.15.x` | `amd64`, `arm64`                  |
| `2.16-awshelm3.15`       | master       | **`2.16.x`** | `3.15.x` | `amd64`, `arm64`                  |
...
| `2.19-awshelm3.14`       | master       | **`2.19.x`** | `3.14.x` | `amd64`, `arm64`                  |
| `2.18-awshelm3.14`       | master       | **`2.18.x`** | `3.14.x` | `amd64`, `arm64`                  |
| `2.17-awshelm3.14`       | master       | **`2.17.x`** | `3.14.x` | `amd64`, `arm64`                  |
| `2.16-awshelm3.14`       | master       | **`2.16.x`** | `3.14.x` | `amd64`, `arm64`                  |
...
| `2.19-awshelm3.13`       | master       | **`2.19.x`** | `3.13.x` | `amd64`, `arm64`                  |
| `2.18-awshelm3.13`       | master       | **`2.18.x`** | `3.13.x` | `amd64`, `arm64`                  |
| `2.17-awshelm3.13`       | master       | **`2.17.x`** | `3.13.x` | `amd64`, `arm64`                  |
| `2.16-awshelm3.13`       | master       | **`2.16.x`** | `3.13.x` | `amd64`, `arm64`                  |
...
| `2.19-awshelm3.12`       | master       | **`2.19.x`** | `3.12.x` | `amd64`, `arm64`                  |
| `2.18-awshelm3.12`       | master       | **`2.18.x`** | `3.12.x` | `amd64`, `arm64`                  |
| `2.17-awshelm3.12`       | master       | **`2.17.x`** | `3.12.x` | `amd64`, `arm64`                  |
| `2.16-awshelm3.12`       | master       | **`2.16.x`** | `3.12.x` | `amd64`, `arm64`                  |
...
| `2.19-awshelm3.11`       | master       | **`2.19.x`** | `3.11.x` | `amd64`, `arm64`                  |
| `2.18-awshelm3.11`       | master       | **`2.18.x`** | `3.11.x` | `amd64`, `arm64`                  |
| `2.17-awshelm3.11`       | master       | **`2.17.x`** | `3.11.x` | `amd64`, `arm64`                  |
| `2.16-awshelm3.11`       | master       | **`2.16.x`** | `3.11.x` | `amd64`, `arm64`                  |
...
make dry ANSIBLE=2.20
make run ANSIBLE=2.20
...
# Build Ansible 2.20 base
# image: cytopia/ansible:2.20
make build VERSION=2.20
```
### Ansible tools
```bash
...
# Build Ansible 2.20 tools
# image: cytopia/ansible:2.20-tools
make build VERSION=2.20 STAGE=tools
```
...
# Build Ansible 2.20 infra
# image: cytopia/ansible:2.20-infra
make build VERSION=2.20 STAGE=infra
```
...
# Build Ansible 2.20 azure
# image: cytopia/ansible:2.20-azure
make build VERSION=2.20 STAGE=azure
```
...
# Build Ansible 2.20 aws
# image: cytopia/ansible:2.20-aws
make build VERSION=2.20 STAGE=aws
```
...
# Build Ansible 2.20 awsk8s
# image: cytopia/ansible:2.20-awsk8s
make build VERSION=2.20 STAGE=awsk8s
```

### Ansible awskops
```bash
# Build latest Ansible with Kops 1.34
# image: cytopia/ansible:latest-awskops1.34
make build VERSION=latest STAGE=awskops KOPS=1.34

# Build Ansible 2.20 with Kops 1.34
# image: cytopia/ansible:2.20-awskops1.34
make build VERSION=2.20 STAGE=awskops KOPS=1.34
```

### Ansible awshelm
```bash
# Build latest Ansible with Helm 3.20
# image: cytopia/ansible:latest-awshelm3.20
make build VERSION=latest STAGE=awshelm HELM=3.20
```
